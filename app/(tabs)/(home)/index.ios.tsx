...
export default function HomeScreen() {
  ...
  async function handleInstantNotification() {
    try {
      ...
      console.log('iOS: Sending instant notification');
      ...
      console.log('iOS instant notification sent successfully');

    } catch (error) {
      console.error('Error sending iOS instant notification:', error);
